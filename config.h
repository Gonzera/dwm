...
#include "/home/gon/.cache/wal/colors-wal-dwm.h"
...
static Key keys[] = {
    ...
    {MODKEY, XK_o, spawn, {.v = rofipasscmd}},
    ...
    {MODKEY | ShiftMask, XK_k, spawn, {.v = playerpause}},
    {MODKEY | ShiftMask, XK_l, spawn, {.v = playernext}},
    {MODKEY | ShiftMask, XK_j, spawn, {.v = playerprevious}},
    {0, XK_Print, spawn, {.v = printsc}},
    {MODKEY | ShiftMask, XK_Print, spawn, {.v = printscf}},
    {MODKEY | ShiftMask, XK_z, spawn, {.v = voldown}},
    {MODKEY | ShiftMask, XK_x, spawn, {.v = volup}},
